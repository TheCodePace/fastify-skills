...
| Delay Accepting Requests | [delay-accepting-requests.md](rules/delay-accepting-requests.md) | HIGH   | Gate traffic until dependencies are ready, Kubernetes readiness/liveness probes    |
...
- **New project setup**: `create-server.md`, `autoload.md`, `encapsulation.md`, `typescript-integration.md`, `delay-accepting-requests.md`
...
- **Startup / readiness**: `delay-accepting-requests.md`, `hooks-lifecycle.md`
