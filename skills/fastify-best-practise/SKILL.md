...
| Deployment              | [deployment.md](rules/deployment.md)                         | HIGH       | Graceful shutdown, health checks, Docker, serverless, trust proxy                                     |
...
- **Production deployment**: `deployment.md`, `create-server.md`, `logging.md`
